...
int main(int argc, char ** argv)
{
  ...
  auto publisher1 = node->create_publisher<sensor_msgs::msg::Image>("video1", 1);
  sensor_msgs::msg::Image::SharedPtr msg1;

  auto publisher2 = node->create_publisher<sensor_msgs::msg::Image>("video2", 1);
  sensor_msgs::msg::Image::SharedPtr msg2;

  auto pub = node->create_publisher<sensor_msgs::msg::Image>("correct_image", 1);

  VideoCapture cap1("/dev/v4l/by-id/usb-046d_罗技高清网络摄像机_C930c_554D90DE-video-index0",CAP_V4L);
  cap1.set(CAP_PROP_FRAME_WIDTH, 640);
  cap1.set(CAP_PROP_FRAME_HEIGHT, 480);

  VideoCapture cap2("/dev/v4l/by-id/usb-046d_罗技高清网络摄像机_C930c_4366BDCE-video-index0",CAP_V4L);
